...
# Beklenen kısa kenarın kaçta kaçı minimum eşik olsun?
# Fazla yüksek olursa hedefi kaçırırsın.
# Fazla düşük olursa gürültüleri hedef sanırsın.
SAFETY_FACTOR = 0.40
...
# Ana kod için güvenli katsayı:
# mean değil p20 kullanıyoruz.
# Çünkü uçuşta hedef beklenenden küçük görünebilir.
